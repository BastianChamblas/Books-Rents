# Generated by Django 3.2.11 on 2024-12-15 17:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rut', models.CharField(blank=True, help_text='Ingresa un RUT válido sin puntos y con guion (Ej: 12345678K)', max_length=12, null=True, unique=True, validators=[app.validators.validar_rut])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.libroarr')),
            ],
        ),
    ]
